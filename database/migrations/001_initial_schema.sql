...
-- Creates all tables, indexes, and RLS policies for Pradyot AI
...
CREATE INDEX IF NOT EXISTS idx_pyq_questions_board_class ON pyq_questions(board, class_level, subject);
CREATE INDEX IF NOT EXISTS idx_pyq_attempts_student      ON pyq_attempts(student_id);
